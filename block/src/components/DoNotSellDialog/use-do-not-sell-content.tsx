...
export const useDoNotSellContent = () => {
	...
	const cookiePolicyLink = <ExternalLink href={localizeUrl('https://automattic.com/cookies/')} />;
	const privacyPolicyLink = <ExternalLink href={localizeUrl('https://automattic.com/privacy/')} />;
	const contactLink = (
